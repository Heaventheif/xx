...
// --- Fallback source: مانجا العاشق (3asq), via an external scrape bridge ---
// Used automatically when the primary MangaDex source can't find the manga
// or the requested chapter/language (previously the separate "manga2" command).
...
export default {
  ...
  onStart: async function ({ api, event, args }) {
    ...
    try {
      ...
      // MangaDex found nothing usable — automatically try the 3asq bridge
      // before giving up (this used to require manually running "manga2").
