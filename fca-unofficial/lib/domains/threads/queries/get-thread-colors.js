...
var e = (r, o) => n(r, 'name', { value: o, configurable: !0 });
const l = {
...
function t() {
  return e(function () {
    return a();
  }, 'getThreadColorsQuery');
}
e(t, 'createGetThreadColorsQuery');
var u = { getThreadColors: a, createGetThreadColorsQuery: t };
export { t as createGetThreadColorsQuery, u as default, a as getThreadColors };

// ─── Plugin Descriptor ──────────────────────────────────────────
/** @type {import('./plugin-provider.js').FcaPlugin} */
export const $plugin = {
  name: 'fca-domains-threads-queries-get-thread-colors',
  meta: { category: 'domain-threads', path: 'lib/domains/threads/queries/get-thread-colors.js' },
  setup(_ctx) {
