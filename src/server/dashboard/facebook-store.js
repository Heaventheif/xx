...
export const $plugin = {
  name: 'xx-server-dashboard-facebook-store',
  meta: { category: 'server-dashboard', path: 'src/server/dashboard/facebook-store.js' },
  setup(_ctx) {
    // provides: clearStoryEvents, getFriendEvents, getStoryEvents, recordFriendEvent, recordStoryEvent
  },
};
