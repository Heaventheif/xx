...
// Get (or lazily create) a session model for the given collection name.
...
// Load the saved conversation context for a key (thread or user).
// Returns at most the last `limit` messages to cap token usage.
...
// Persist the conversation context for a key.
...
// Clear the conversation context for a key.
